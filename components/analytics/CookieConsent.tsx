      ...
      <AnimatePresence>
        {open ? (
          <m.section
            ...
            className="motion-fade fixed inset-x-4 bottom-4 z-[80] mx-auto max-w-[720px] rounded-[15px] border border-[#E3E9F2] bg-white p-5 shadow-[0_18px_50px_-18px_rgba(0,26,40,0.45)] md:p-6"
          >
            ...
            <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:justify-end">
              <button
                ...
                className="border border-brand-dark px-6 py-3 text-[15px] font-semibold text-brand-dark transition-colors duration-200 hover:bg-[#f0f4fa] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-mid"
              >
                Hafna
              </button>
              <button
                ...
                className="border border-brand-dark bg-brand-dark px-6 py-3 text-[15px] font-semibold text-white transition-colors duration-200 hover:border-brand-mid hover:bg-brand-mid focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-mid"
              >
                Samþykkja
              </button>
            </div>
