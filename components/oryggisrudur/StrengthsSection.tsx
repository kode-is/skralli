...
export function StrengthsSection() {
  return (
    <section className="bg-[#f0f4fa] py-16 md:py-20">
      <Container>
        <h2 className="text-3xl font-bold text-neutral-900 md:text-4xl">Styrkleikar Hammerglass</h2>
        <div className="mt-8 grid gap-4 sm:grid-cols-2">
          {STRENGTHS.map((strength) => (
            <div key={strength} className="flex items-center rounded-2xl bg-white px-6 py-5 shadow-sm">
              <h3 className="text-base font-semibold text-neutral-900">{strength}</h3>
            </div>
          ))}
          <Link
            href="/hafa-samband"
